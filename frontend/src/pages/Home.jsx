...
const Home = () => {
  return (<>
    ...
    <div style={{fontFamily: "Montserrat"}}
         className="lg:tracking-widest sm:tracking-wide lg:text-3xl sm:text-xl pt-3 text-slate-900 lg:h-[80vh] bg-[url('./assets/GUB-cover.jpg')] lg:bg-[cover] sm:bg-[contain] sm:h-[60vh] justify-start font-bold items-center flex flex-col overflow-hidden">
